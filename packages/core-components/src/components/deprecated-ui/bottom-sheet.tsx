...
import { Button } from "../deprecated-ui/button";
import * as Slot from "../primitives/slot";

export type BottomSheetRef = React.ElementRef<typeof View>;
export type BottomSheetProps = React.ComponentPropsWithoutRef<typeof View>;
...
const BOTTOM_SHEET_HEADER_HEIGHT = 70; // BottomSheetHeader height
...
const BottomSheetHeader = React.forwardRef<
	...
	BottomSheetHeaderProps & { rightChildren?: React.ReactElement }
		...
		>
			...
			<View className="flex flex-row items-center gap-2">
				...
				<Button onPress={close} variant="ghost" className="pr-4">
					<FontAwesome6 name="x" className="text-muted-foreground" size={24} />
				</Button>
			</View>
		</View>
	);
